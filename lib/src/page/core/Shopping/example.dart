...
class _exampleState extends State<example> {
  /*List<CarouselSimpleModel> list = [
    CarouselSimpleModel(
        imageUrl:
            'https://freeforcommercialuse.net/wp-content/uploads/2020/06/msp_2005_7840.jpg',
        textFromImage: 'Cafe'),
    CarouselSimpleModel(
        imageUrl:
            'https://freeforcommercialuse.net/wp-content/uploads/2020/06/msp_2005_7087.jpg',
        textFromImage: 'Colores azules'),
  ];
*/
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: Container(
          child: // CarouselSimple(list, Colors.blueGrey, Colors.white),
              mesage(),
        ),
      ),
    );
