...
const shoes = [
  const Shoe(
      ...
      price: 130.00,
      image: 'assets/image/shoes/1.png',
      color: Color(0xFF5574b9)),
  const Shoe(
      name: 'NIKE AIR-MAX',
      price: 130.00,
      image: 'assets/image/shoes/2.png',
      color: Color(0xFF52b8c3)),
  const Shoe(
      name: 'NIKE AIR-270',
      price: 150.00,
      image: 'assets/image/shoes/3.png',
      color: Color(0xFFE3AD9B)),
  const Shoe(
      name: 'NIKE EPICT-REACTII',
      price: 160.00,
      image: 'assets/image/shoes/4.png',
      color: Color(0xFF444547)),
];

const shoesBottom = [
  const Shoe(
      name: 'NIKE AIR-MAX', price: 170.00, image: 'assets/image/shoes/3.png'),
  const Shoe(
      name: 'NIKE AIR FORCE', price: 130.00, image: 'assets/image/shoes/4.png'),
];
                  ...
                  child: Padding(
                    ...
                    child: RotatedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildLeftItem('Nuevos', false),
                          leftItemSeparator,
                          _buildLeftItem('Destacado', true),
                          leftItemSeparator,
                          _buildLeftItem('Proximamente', false),
                        ],
                      ),
                    ),
                  ),
